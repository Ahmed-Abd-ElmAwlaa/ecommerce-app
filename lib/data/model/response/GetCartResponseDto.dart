...
class GetProductDto extends GetProductEntity {
  ...
  GetProductDto.fromJson(dynamic json) {
    count = json['count'];
    id = json['_id'];
    product = json['product'] != null ? GetProductDataDto.fromJson(json['product']) : null;
    price = json['price'];
  }
...
class GetProductDataDto extends GetProductDataEntity {
  ...
  GetProductDataDto.fromJson(dynamic json) {
    ...
    category = json['category'] != null ? CategoryOrBrandDto
        .fromJson(json['category']) : null;
    brand = json['brand'] != null ? CategoryOrBrandDto.
    fromJson(json['brand']) : null;
