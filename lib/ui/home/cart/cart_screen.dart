...
import 'package:ecommerce/ui/home/cart/cubit/CartScreenViewModel.dart';
...
class CartScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider<CartScreenViewModel>(
      create: (context) => cartScreenViewModel..getCart(),
      child: BlocBuilder<CartScreenViewModel,
          CartScreenStates>(
          //bloc: cartScreenViewModel..getCart(),
          builder:(context, state) {
           return Scaffold(
                ...
                body:
                state is CartScreenSuccessStates?
             Column(
                  ...
                  children: [
                    Expanded(
                      child: ListView.builder(
                        itemBuilder: (context, index) {
                          return CartItem(getProductEntity:state.
                    ...
                    Padding(
                      padding: EdgeInsets.
                      only(bottom: 55.h, left: 16.w, right: 16.w),
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Column(
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: Icon(Icons.arrow_forward,
                                          size: 26.w, color: AppColors.whiteColor),
                                    ),
                                  ],
                                ),
                              ),
