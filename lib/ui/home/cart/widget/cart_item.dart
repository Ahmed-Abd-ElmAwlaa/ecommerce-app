...
class CartItem extends StatelessWidget {
  ...
  CartItem({required this.getProductEntity,super.key});
      ...
      child: Container(
        ...
        child: Row(children: [
          Container(
            ...
            child: Image.network(getProductEntity.product?.imageCover??"",
                fit: BoxFit.fill),
          ),
          Expanded(
              child: Padding(
            ...
            child: Column(
                ...
                children: [
                      ...
                      children: [
                        ...
                        InkWell(
                          onTap: () {
                            ...
                            deleteItemInCart(getProductEntity.
                            product?.id??"");
                          },
                          child: const Icon(
                  ...
                  Padding(
                    padding: EdgeInsets.
                    only(top: 13.h, bottom: 13.h),
                    child:
                    Text('Count:${getProductEntity.count} ',
                        style: Theme.of(context)
                            .textTheme
                            .titleMedium!
                            .copyWith(color:
                  ...
                  Expanded(
                    child: Padding(
                      ...
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Text('EGP ${getProductEntity.price}',
                              style: Theme.of(context)
                                  .textTheme
                                  .titleMedium!
                                  .copyWith(
                              ...
                              children: [
                                IconButton(
                                  ...
                                  onPressed: () {
                                    ...
                                    counter--;
                                    CartScreenViewModel.get(context).
                                    updateCountInCart(getProductEntity.
                                    product?.id??"",counter);
                                  },
                                  icon: Icon(
